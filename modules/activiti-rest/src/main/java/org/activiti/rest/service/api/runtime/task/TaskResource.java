...
public class TaskResource extends TaskBaseResource {
  ...
  @RequestMapping(value="/runtime/tasks-involvement/{assignee}", method = RequestMethod.GET, produces="application/json")
  public TaskResponse getTaskByInvolvement (@PathVariable String assignee, HttpServletRequest request) {
    return restResponseFactory.createTaskResponse(getTaskFromRequest(assignee));
  }
